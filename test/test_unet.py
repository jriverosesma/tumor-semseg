...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((10, 1, 256, 256), UNetConfig(7, 1, "Sigmoid", {"inplace": True}, True)),
        ((10, 1, 64, 64), UNetConfig(4, 1, "Sigmoid", {"inplace": True}, False)),
        ((10, 1, 256, 128), UNetConfig(1, 1, "Sigmoid", {"inplace": True}, True)),
    ],
)
