...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((2, 3, 256, 256), DeepLabv3Config(10, 3, "deeplabv3_resnet50", False)),
        ((2, 3, 256, 256), DeepLabv3Config(5, 3, "deeplabv3_resnet50", True)),
        ((2, 3, 256, 256), DeepLabv3Config(10, 3, "deeplabv3_resnet101", False)),
        ((2, 3, 256, 256), DeepLabv3Config(5, 3, "deeplabv3_resnet101", True)),
    ],
)
